...
module.exports = function initializeApp() {
  ...
  if (process.env.SESSION_MODE === 'token') {
    post('end_session_confirm', `${routes.end_session}/init`, error(this, 'end_session_confirm.error'), ...endSession.fromBackend);
    post('end_session_confirm', `/delete/session/init`, error(this, 'end_session_confirm.error'), ...endSession.fromFrontend);
    post('end_session_confirm', `/remove/access/init`, error(this, 'end_session_confirm.error'), ...endSession.removeAccess);
    post('end_session_confirm', `/remove/profile/init`, error(this, 'end_session_confirm.error'), ...endSession.removeProfile);
  }
